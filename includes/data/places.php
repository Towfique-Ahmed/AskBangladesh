...
return [
    ...
    'travel' => [
        ...
        ['name' => 'Himchari National Park', 'district' => "Cox's Bazar", 'type' => 'Nature', 'lat' => 21.3500, 'lon' => 92.0333, 'best' => 'Nov – Mar', 'emoji' => '🌴', 'desc' => 'Low hills tumbling straight into the Bay of Bengal — seasonal waterfalls and a lookout over the world’s longest beach.'],
        ['name' => 'Madhabkunda Waterfall', 'district' => 'Moulvibazar', 'type' => 'Waterfall', 'lat' => 24.6244, 'lon' => 92.2081, 'best' => 'Jun – Sep', 'emoji' => '💧', 'desc' => 'The tallest waterfall in the Sylhet region, crashing through the Patharia hills into a natural pool below.'],
        ['name' => 'Lawachara National Park', 'district' => 'Moulvibazar', 'type' => 'Forest', 'lat' => 24.3225, 'lon' => 91.7810, 'best' => 'Oct – Mar', 'emoji' => '🐒', 'desc' => 'A pocket of tropical rainforest inside the tea belt — home to Bangladesh’s only wild population of hoolock gibbons.'],
        ['name' => 'Boga Lake (Bogakain)', 'district' => 'Bandarban', 'type' => 'Lake', 'lat' => 21.7186, 'lon' => 92.5290, 'best' => 'Oct – Feb', 'emoji' => '🏞️', 'desc' => 'A legendary crater-shaped lake at 2,400 feet, ringed by Bawm hill villages and reached only on foot.'],
        ['name' => 'Puthia Temple Complex', 'district' => 'Rajshahi', 'type' => 'Heritage', 'lat' => 24.3833, 'lon' => 88.9833, 'best' => 'Nov – Mar', 'emoji' => '🛕', 'desc' => 'The largest cluster of Hindu temples in Bangladesh, raised by the Puthia zamindars over two centuries.'],
        ['name' => 'Shalbon Vihara', 'district' => 'Comilla', 'type' => 'Heritage', 'lat' => 23.4372, 'lon' => 91.1198, 'best' => 'Nov – Mar', 'emoji' => '🏛️', 'desc' => 'An 8th-century Buddhist monastery mound at the heart of the Mainamati ruins, excavated from the Lalmai hills.'],
        ['name' => 'Star Mosque (Tara Masjid)', 'district' => 'Dhaka', 'type' => 'Heritage', 'lat' => 23.7203, 'lon' => 90.4033, 'best' => 'All year', 'emoji' => '⭐', 'desc' => 'A 19th-century Armanitola mosque encrusted with star-motif Japanese and English chinaware mosaic.'],
        ['name' => 'Curzon Hall', 'district' => 'Dhaka', 'type' => 'Architecture', 'lat' => 23.7267, 'lon' => 90.3958, 'best' => 'All year', 'emoji' => '🎓', 'desc' => 'Dhaka University’s red-brick Indo-Saracenic showpiece, opened in 1904 and named for a viceroy who opposed it.'],
        ['name' => 'Ramsagar National Park', 'district' => 'Dinajpur', 'type' => 'Lake', 'lat' => 25.5822, 'lon' => 88.6717, 'best' => 'Nov – Feb', 'emoji' => '🦢', 'desc' => 'A vast 15th-century reservoir turned national park, ringed by forest and visited by migratory birds each winter.'],
        ['name' => 'Bhawal National Park', 'district' => 'Gazipur', 'type' => 'Forest', 'lat' => 24.0154, 'lon' => 90.3670, 'best' => 'Nov – Mar', 'emoji' => '🌳', 'desc' => 'A sal forest just north of Dhaka, once the royal hunting ground of the Bhawal zamindars.'],
    ],
