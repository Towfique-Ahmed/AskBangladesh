...
$nav = [
    ...
    ['path' => 'jobs',       'page' => 'jobs',       'label' => 'Jobs',       'icon' => '💼'],
    ...
    ['path' => 'presidents', 'page' => 'presidents', 'label' => 'Presidents', 'icon' => '🎖️'],
    ['path' => 'prime-ministers', 'page' => 'prime-ministers', 'label' => 'Prime Ministers', 'icon' => '🧑‍💼'],
